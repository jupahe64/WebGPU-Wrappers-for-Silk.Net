...
namespace DeferredRendering
{
    internal class DeferredShader
    {
        ...
        public DeferredShader(DevicePtr device, RenderPipelinePtr pipeline, BindGroupLayoutPtr textureBindGroupLayout, 
        ...
        public void Apply(CommandEncoderPtr cmd, QueuePtr queue, TextureViewPtr inAlbedo, TextureViewPtr inNormal, TextureViewPtr inDepth, TextureViewPtr output, 
            Matrix4X4<float> inverseViewProjection, BufferPtr lightsBuffer, uint lightCount)
        {
            ...
            cmd.InsertDebugMarker("Right before pass!!!!!!!");
